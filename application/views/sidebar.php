          <ul><?php foreach($menu as $entry): ?> 
            <li<?php if(strtolower($entry['controller']) == $controller) echo ' class="pure-menu-selected"'; ?>><a href="<?php echo $this->config->base_url($entry['ref']); ?>"><?php echo $entry['title']; ?></a></li><?php endforeach; ?> 
